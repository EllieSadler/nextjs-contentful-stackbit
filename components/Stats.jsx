...
export const Stats = (props) => {
    return (
        <div className={`py-24 px-12 text-center ${themeClassMap[props.theme] ?? themeClassMap['dark']}`} data-sb-object-id={props.id}>
...
const StatItem = (props) => {
    return (
        <div className={`px-4 py-8 rounded-md ${itemThemeClassMap[props.theme] ?? itemThemeClassMap['dark']}`} data-sb-object-id={props.id}>
